...
Example:
`docker run -d --name gamunner -e DUCKDNS_DOMAINS=<subdomain1,...> -e DUCKDNS_TOKEN=<token> -v /some/path2store/data:/data -p 2222:2222/tcp -p 25565:25565/tcp --restart=unless-stopped drew6017/gamerunner`
